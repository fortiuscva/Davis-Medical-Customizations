report 52600 "DME Sales Invoice NA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/DMESalesInvoiceNA.rdl';
    Caption = 'DME Sales - Invoice';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    { }
                    column(DMECurrency_Code; "Sales Invoice Header"."Currency Code")
                    { }
                    column(DMECustRefNumbCaption; CustRefNumbCaptionLbl)
                    { }
                    column(DMEYour_Reference; "Sales Invoice Header"."Your Reference")
                    { }
                    column(DMEContactCaption; ContactCaptionLbl)
                    { }
                    column(DMESell_to_Contact; "Sales Invoice Header"."Sell-to Contact")
                    { }
                    ...
                    { }
                    column(DMEOrder_No_; "Sales Invoice Header"."Order No.")
                    { }
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(TempSalesInvoiceLineAmtAmtExclInvDisc; AmountExclInvDisc - TempSalesInvoiceLine.Amount)
                        {
                        }
                        ...
                        { }
                        column(DMETempSalesInvoiceLineRec_LineDisc; TempSalesInvoiceLine."Line Discount %")
                        { }
                        ...
                        { }
                        column(DMELotNo; LotNo)
                        { }
                        column(DMETempSalesInvoiceLine_Description; TempSalesInvoiceLine.Description)
                        { }
                        ...
                        dataitem(ItemTrackingSpec; Integer)
                        {
                            ...
                            column(DMETempItemLedgEntry_ItemNo; TempItemLedgEntry."Item No.")
                            { }
                            ...
                            begin
                                if Number = 1 then begin
                                    ...
                                    //LotNo := 'Serial Numbers: ' + TempItemLedgEntry."Serial No.";
                                    LotNo := TempItemLedgEntry."Serial No.";
                                end else begin
    ...
    var
        ...
        InvoiceDiscountCaptionLbl: Label 'Discount Amount Exlc. Tax:';
    ...
    local procedure GetSerialLotNo()
    var
    ...
    begin
        ...
        /*if TempItemLedgEntry.FindSet() then
            repeat
                if LotNo = '' then
                    LotNo := 'Lot No.: ' + TempItemLedgEntry."Lot No."
                else
                    LotNo += ', ' + TempItemLedgEntry."Lot No.";
