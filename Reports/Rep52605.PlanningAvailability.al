report 52605 "DME Planning Availability"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/DMEPlanningAvailability.rdl';
    ApplicationArea = All;
    Caption = 'DME Planning Availability';
    ...
    dataset
    {
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            column(DMEMinQtyCaption; MinQtyCaptionLbl)
            { }
            column(DMEMaxQtyCaption; MaxQtyCaptionLbl)
            { }
            column(Item_MinOrderQty; Item."Minimum Order Quantity")
            { }
            column(Item_MaxOrderQty; Item."Maximum Order Quantity")
            { }
    ...
    var
        ...
        MinQtyCaptionLbl: Label 'Min. Qty.: ';
        MaxQtyCaptionLbl: Label 'Max. Qty.: ';
